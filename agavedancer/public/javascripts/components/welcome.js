		...
		return(
			<div className="welcome">
				<div className="section">
					...
					<br />
					<div>
						The SciApps platform is supported by <a href="http://nsf.gov" target="_blank">National Science Foundation</a> DBI-1265383 (the CyVerse project), and in part by  <a href="https://cshl.edu">Cold Spring Harbor Laboratory</a>. 
					</div>
					<br /><br />
					<div id="myimages">
